...
struct class_ro_t {
    ...
    const char * name;
    method_list_t * baseMethodList;    // entsize_list_tt
    protocol_list_t * baseProtocols;   // protocol_list_t
    const ivar_list_t * ivars;         // entsize_list_tt

    const uint8_t * weakIvarLayout;
    property_list_t *baseProperties;   // entsize_list_tt
...
struct class_rw_t {
    ...
    method_array_t methods;         // list_array_tt
    property_array_t properties;    // list_array_tt
    protocol_array_t protocols;     // list_array_tt
